 ...
 * @file     app_att.c
 *
 * @brief    GATT attribute table for FitPro LT715 BLE advertising example
...
gap_periConnectParams_t my_periConnParameters = {20, 80, 0, 4000};
...
// Device name: "FitPro-LT715"
const u8 my_devName[] = {'F', 'i', 't', 'P', 'r', 'o', '-', 'L', 'T', '7', '1', '5'};
